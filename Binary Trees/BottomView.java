...
// { Driver Code Starts
    ...
    //// MAIN CODE REQUIRED TO GET THE BOTTOM VIEW OF THE GIVEN TREE----------------------------------------------------------------------->
        ...
        public ArrayList <Integer> bottomView(Node root)
        {
            ...
            while(!qn.isEmpty()){
                ...
                for(int key:tm.keySet()){
                    ...
                    List<Integer> res= tm.get(key);
                    hm.get(key).addAll(res);
                }
            }

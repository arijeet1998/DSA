public class CheckForBalancedTree {
    ...
    class Tree {
        ...
        boolean isBalanced(Node root) {
            ...
            // can't be placed above the base condition because null.left or null.right is
        ...
        // O(n2) since it has to find the height for each step of balancing and if its
        // increasing only in one direction it will take o(n) to get its height and for
        // each height I aam trying to get the balanced which is O(n) in worst case
        // O(n x n)
